...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* CONFIG_GPIO_RAW_DATA */
...
const uint_least8_t CONFIG_GPIO_RAW_DATA_CONST = CONFIG_GPIO_RAW_DATA;
