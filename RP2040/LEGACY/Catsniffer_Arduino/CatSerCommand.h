 ...
 */
#ifndef CatSerCommand_h
#define CatSerCommand_h
...
class CatSerCommand {
	...
	void addCommand(const char *command,
			void (*function)()); // Add a command to the processing
					     // dictionary.
	void setDefaultHandler(void (*function)(const char *)); // A handler to
								// call when no
								// valid command
								// received.
	...
	SerialCommandCallback *commandList; // Actual definition for
	...
	char buffer[SERIALCOMMAND_BUFFER + 1]; // Buffer of stored characters
					       // while waiting for terminator
					       // character
